...
import 'package:otax/core/models/comment_model.dart';
import 'package:otax/ui/models/widgets/comment.dart';
...
class _CommentsectionState extends State<Commentsection> {
  ...
  final List<CommentResponse> paginatedComments = [];
  ...
  Future<void> fetchComments({String? cursor}) async {
    ...
    // For now, using generated fake comments from genfakeComments()
    setState(() {});
  }
