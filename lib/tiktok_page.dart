...
class _TiktokDownloaderPageState extends State<TiktokDownloaderPage> {
  ...
  Future<void> _downloadTiktok() async {
    ...
    final apiUrl = Uri.parse("https://api.ryzumi.net/api/downloader/ttdl?url=$encodedUrl");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (json['success'] == true && json['data'] != null && json['data']['data'] != null) {
          ...
          setState(() {
            _videoData = {
              ...
              'videoWm': result['wmplay'] ?? "",
              'videoHd': result['hdplay'] ?? "",
  ...
  Future<void> _shareVideo() async {
    ...
    try {
      String? videoUrl = _videoData!['videoUrl'] ?? _videoData!['videoWm'] ?? _videoData!['videoHd'];
